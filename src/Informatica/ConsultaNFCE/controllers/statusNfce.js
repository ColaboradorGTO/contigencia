  ...
  async validarConsulta(req, res) {
    try {
      ...
      if (!vendas) {
        ...
        const apiUrl = `http://164.152.245.77:8000/quality/concentrador/api/venda/valida-venda-contingencia.xsjs?page=${page}&pageSize=${pageSize}&dataLimite=${dataInicio}&dataFechamento=${dataFim}`;
